<x-app-layout>
    <div class="pb-32 sm:pb-20 bg-slate-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12">
            ...
            <!-- Product Main Card -->
            <div class="bg-white rounded-2xl border border-slate-100 shadow-xl shadow-slate-100/50 p-6 sm:p-12 overflow-hidden">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div class="lg:col-span-6 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mb-6">
                                @if($product->is_active)
                                    <span class="inline-flex items-center px-3.5 py-1 rounded-full text-[10px] font-black bg-slate-100 text-slate-600 uppercase tracking-widest border border-slate-200">Ready Stock</span>
                                @else
                                    <span class="inline-flex items-center px-3.5 py-1 rounded-full text-[10px] font-black bg-rose-50 text-rose-600 uppercase tracking-widest border border-rose-100">Out of Stock</span>
                                @endif
                                @if($product->sold > 0)
                                    <span class="inline-flex items-center px-3.5 py-1 rounded-full text-[10px] font-black bg-orange-50 text-primary-600 uppercase tracking-widest border border-primary-100">Terjual {{ $product->sold }} Unit</span>
                                @endif
                            </div>
                        ...
                        <div class="hidden sm:block">
                            @if($product->is_active)
                                <a href="{{ $waUrl }}" target="_blank" rel="noopener noreferrer" class="w-full flex items-center justify-center py-4 bg-primary-600 hover:bg-primary-500 text-white rounded-2xl font-black text-sm uppercase tracking-widest active:scale-95 transition-all shadow-lg hover:shadow-xl hover:shadow-primary-100 gap-3 hover:translate-y-[-1px]">
                            ...
                            @else
                                <button disabled class="w-full flex items-center justify-center py-4 bg-slate-200 text-slate-400 rounded-2xl font-black text-sm uppercase tracking-widest cursor-not-allowed">
                                    Produk Tidak Tersedia / Out of Stock
                                </button>
                            @endif
                        </div>
                    </div>
